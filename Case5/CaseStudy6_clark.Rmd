...
While our optimized model exceeded our base model on each metric, we will want to visualize the optimizations using an ROC curve, which you can see below. 
