...
bjase2
```
Looking at the Yule Walker Approach, we can see that we didn not see improvement. 
...
#set.seed(255)
fit.mlp= mlp(flu_train, lags=1:52, hd.auto.type="valid",hd.max=10)
fit.mlp
plot(fit.mlp)
```
